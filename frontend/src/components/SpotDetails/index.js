            ...
            if (sessionUser) {
                  ...
                  return (
                        ...
                        <div id='detailsPage'>
                              ...
                              <div id='mobile-details-page'>
                                    <img id='photo-mobile' src={spot.SpotImages[0].url} />
                                    <div id='details-mobile'>
                                          <h3 id='name-mobile'>{spot.name}</h3>
                                          <div id='location-mobile'>{`${spot.city}, ${spot.state}, ${spot.country}`}</div>
                                          <div id='host-mobile'>{`Hosted by ${spot.Owner.firstName} ${spot.Owner.lastName}`}</div>
                                          <p id='desc-mobile'>{spot.description}</p>

                                          <div id='rateBox-mobile'>
                                                            <div id='reserveBox'>
                                                                  <div id='rateStars'>
                                                                        <div id='night'>
