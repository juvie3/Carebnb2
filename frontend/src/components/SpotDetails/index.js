...
export const SpotDetails = () => {
  ...
  if (spot === undefined) {
    ...
    if (sessionUser) {
          ...
          <div id="detailsHolder">
            <div id="detailsP1">
              ...
              <div
                id="cityStateCountry"
                className="spotName"
              >{`${spot.city}, ${spot.state}, ${spot.country}`}</div>
            </div>
              ...
              <div id="imageHolder">
                <div id="previewImage">
                  {spot.SpotImages[0] ? (
                    <OpenModalPhotoPR
                      modalComponent={
                        <PhotoModal src={spot.SpotImages[0].url} />
                      }
                  ...
                  <div id="leftImages">
                    <div className="topImage">
                      {spot.SpotImages[1] ? (
                        <OpenModalPhoto
                          modalComponent={
                            <PhotoModal src={spot.SpotImages[1].url} />
                          }
                    ...
                    <div className="bottomImage">
                      {spot.SpotImages[2] ? (
                        <OpenModalPhoto
                          modalComponent={
                            <PhotoModal src={spot.SpotImages[2].url} />
                          }
                  ...
                  <div id="rightImages">
                    <div className="topImage">
                      {spot.SpotImages[3] ? (
                        <OpenModalPhotoTR
                          modalComponent={
                            <PhotoModal src={spot.SpotImages[3].url} />
                          }
                    ...
                    <div className="bottomImage">
                      {spot.SpotImages[4] ? (
                        <OpenModalPhotoBR
                          modalComponent={
                            <PhotoModal src={spot.SpotImages[4].url} />
                          }
      ...
      const flag = reviews.find(
        (review) => review.User?.id === sessionUser && sessionUser.id
      );
      if (flag) redLight = true;
